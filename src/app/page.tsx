...
export default function Home() {
  ...
  useGSAP(()=>{
    ...
    mm.add({
      ...
      if(logo && i == 0){
        ...
        gsap.to(logo,{
          scale : isLaptop ? 0.3 : 0.5,
          top : isLaptop ? -300  : -60,
          left : isLaptop ? -300 : -100,
          zIndex : 10,
          scrollTrigger : {
            trigger : section,
            scroller : containerElement,
  ...
  return (
    <div className="relative h-screen w-screen overflow-x-hidden overflow-y-hidden" ref={scrollPageRef}>
      {/* intro section */}
      ...
      <div className="page-section h-screen text-white mt-4">
